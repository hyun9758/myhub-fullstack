...
| 작성일 | 2026-08-20 |
| 상태 | 검토완료 |
| 작성자 | ymbaek (초안), 정현수 (v0.4 그릴링, v0.5 8.1 신규기능) |
...
| 날짜 | 버전 | 변경 내용 |
|---|---|---|
| 2026-08-20 | v0.5 | 8.1 신규 기능 추가: Projects 도메인을 구현 범위로 편입(유저스토리 USG-08, 데이터 요구사항 ENT-PROJECT 신설). PRD 자체의 In/Out Scope는 원래부터 Projects를 포함하고 있었으므로 변경 없음 — 하위 문서(`myhub_us.md`, `myhub_data_req.md`)의 구현 범위만 확장됨 |
